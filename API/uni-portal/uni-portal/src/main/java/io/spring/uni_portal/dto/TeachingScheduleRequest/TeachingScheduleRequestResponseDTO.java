...
public class TeachingScheduleRequestResponseDTO {

    private Long scheduleId;
    private TeachingAssignmentDTO assignment; // Thêm thông tin từ teaching_assignment
...
//    private String classType;
    ...
    // DTO cho TeachingAssignment
    public static class TeachingAssignmentDTO {
        private Long assignmentId;
        private LecturerDTO lecturer; // Thông tin giảng viên
        private SubjectDTO subject;   // Thông tin môn học
        private TermClassDTO termClass; // Thông tin kỳ học
        ...
        public static class SubjectDTO {
            ...
            public Integer getLtCredits() {
                return ltCredits != null ? ltCredits : 0;
            }
            ...
            public Integer getThCredits() {
                return thCredits != null ? thCredits : 0;
            }
